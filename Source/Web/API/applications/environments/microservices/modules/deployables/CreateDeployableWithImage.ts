...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/with-image');
...
export class CreateDeployableWithImage extends Command<ICreateDeployableWithImage> implements ICreateDeployableWithImage {
    readonly route: string = '/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/with-image';
