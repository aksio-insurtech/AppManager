...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/environment-variables');
...
export class SetEnvironmentVariableForDeployable extends Command<ISetEnvironmentVariableForDeployable> implements ISetEnvironmentVariableForDeployable {
    readonly route: string = '/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/environment-variables';
