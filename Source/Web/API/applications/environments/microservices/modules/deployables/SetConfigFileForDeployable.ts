...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/config-files');
...
export class SetConfigFileForDeployable extends Command<ISetConfigFileForDeployable> implements ISetConfigFileForDeployable {
    readonly route: string = '/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/config-files';
