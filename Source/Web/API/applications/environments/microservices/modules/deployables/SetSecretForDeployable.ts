...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/secrets');
...
export class SetSecretForDeployable extends Command<ISetSecretForDeployable> implements ISetSecretForDeployable {
    readonly route: string = '/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables/{{deployableId}}/secrets';
