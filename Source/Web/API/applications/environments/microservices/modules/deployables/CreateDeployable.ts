...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables');
...
export class CreateDeployable extends Command<ICreateDeployable> implements ICreateDeployable {
    readonly route: string = '/api/applications/{{applicationId}}/environments/{{environmentId}}/microservices/{{microserviceId}}/modules/{{moduleId}}/deployables';
