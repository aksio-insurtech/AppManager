...
export class AddCertificateToApplicationEnvironment extends Command<IAddCertificateToApplicationEnvironment> implements IAddCertificateToApplicationEnvironment {
    ...
    static use(initialValues?: IAddCertificateToApplicationEnvironment): [AddCertificateToApplicationEnvironment, SetCommandValues<IAddCertificateToApplicationEnvironment>] {
