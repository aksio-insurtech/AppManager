...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/microservices/{{microserviceId}}/module/{{moduleId}}/deployables/{{deployableId}}/image');
...
export class SetImage extends Command<ISetImage> implements ISetImage {
    readonly route: string = '/api/applications/{{applicationId}}/microservices/{{microserviceId}}/module/{{moduleId}}/deployables/{{deployableId}}/image';
