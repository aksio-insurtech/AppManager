...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/{environment}/ingresses/{ingressId}/route');
...
export class SetRoute extends Command<ISetRoute> implements ISetRoute {
    readonly route: string = '/api/applications/{{applicationId}}/{environment}/ingresses/{ingressId}/route';
