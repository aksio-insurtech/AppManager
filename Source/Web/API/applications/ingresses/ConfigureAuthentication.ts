...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/{environment}/ingresses/{ingressId}/authentication');
...
export class ConfigureAuthentication extends Command<IConfigureAuthentication> implements IConfigureAuthentication {
    readonly route: string = '/api/applications/{{applicationId}}/{environment}/ingresses/{ingressId}/authentication';
