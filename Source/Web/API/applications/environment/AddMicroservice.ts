...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environment/{{environment}}/ingress');
...
export class AddMicroservice extends Command<IAddMicroservice> implements IAddMicroservice {
    readonly route: string = '/api/applications/{{applicationId}}/environment/{{environment}}/ingress';
