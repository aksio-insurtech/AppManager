...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/enviro{{environment}}/config');
...
export class SetConfig extends Command<ISetConfig> implements ISetConfig {
    readonly route: string = '/api/applications/{{applicationId}}/enviro{{environment}}/config';
