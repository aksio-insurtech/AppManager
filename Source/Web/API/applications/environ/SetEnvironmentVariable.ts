...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environ{{environment}}/environment-variable');
...
export class SetEnvironmentVariable extends Command<ISetEnvironmentVariable> implements ISetEnvironmentVariable {
    readonly route: string = '/api/applications/{{applicationId}}/environ{{environment}}/environment-variable';
