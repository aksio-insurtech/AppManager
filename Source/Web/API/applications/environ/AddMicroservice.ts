...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/environ{{environment}}/ingress');
...
export class AddMicroservice extends Command<IAddMicroservice> implements IAddMicroservice {
    readonly route: string = '/api/applications/{{applicationId}}/environ{{environment}}/ingress';
