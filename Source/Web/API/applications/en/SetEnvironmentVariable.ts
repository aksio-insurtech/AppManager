...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/en{{environment}}/environment-variable');
...
export class SetEnvironmentVariable extends Command<ISetEnvironmentVariable> implements ISetEnvironmentVariable {
    readonly route: string = '/api/applications/{{applicationId}}/en{{environment}}/environment-variable';
