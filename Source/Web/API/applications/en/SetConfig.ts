...
const routeTemplate = Handlebars.compile('/api/applications/{{applicationId}}/en{{environment}}/config');
...
export class SetConfig extends Command<ISetConfig> implements ISetConfig {
    readonly route: string = '/api/applications/{{applicationId}}/en{{environment}}/config';
