...
export class SetEnvironmentVariableForApplication extends Command<ISetEnvironmentVariableForApplication> implements ISetEnvironmentVariableForApplication {
    ...
    static use(initialValues?: ISetEnvironmentVariableForApplication): [SetEnvironmentVariableForApplication, SetCommandValues<ISetEnvironmentVariableForApplication>] {
