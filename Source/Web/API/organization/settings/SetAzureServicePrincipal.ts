...
const routeTemplate = Handlebars.compile('/api/organization/settings/service-principal');
...
export class SetAzureServicePrincipal extends Command<ISetAzureServicePrincipal> implements ISetAzureServicePrincipal {
    readonly route: string = '/api/organization/settings/service-principal';
    ...
    static use(initialValues?: ISetAzureServicePrincipal): [SetAzureServicePrincipal, SetCommandValues<ISetAzureServicePrincipal>] {
