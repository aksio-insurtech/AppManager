...
{
    public static JsonObject ConfigureAppSettingsHint(this JsonObject json)
    {
        json["README"] = "This file is autogenerated by appmanager, and will be overwritten on each solution deployment";
        return json;
    }
