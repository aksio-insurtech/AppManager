...
public class Deployables : Controller
{
        ...
        [FromBody] CreateDeployableWithImage command)
    {
        ...
        await _eventLog.Append(environmentId, new DeployableImageChanged(applicationId, environmentId, microserviceId, ApplicationEnvironmentConsolidationId.New(), command.DeployableId, command.Image));
    }
}
